# Desloppify : Documentation Cleanup
## 2026-07-27

### Changes
Prose cleanup across documentation files: shorten sentences, replace AI-signal phrasing, fix typos. No technical content changed.

- **README.md** : rewrote long paragraphs into short active-voice sentences. Fixed "completley" typo. Removed em-dashes. Preserved all factual content (license terms, AI authorship credit, source material credits)
- **docs/orbital-card-guide.md** : replaced em-dashes with colons (15 occurrences)
- **docs/polar-card-guide.md** : replaced em-dashes with colons (5 occurrences)
- **docs/reference-animation-cut-sheet.md** : replaced em-dashes with colons (3 occurrences)

### Files Changed
README.md, docs/orbital-card-guide.md, docs/polar-card-guide.md, docs/reference-animation-cut-sheet.md
